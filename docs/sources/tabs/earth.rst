...
.. |biohazard| image:: Figures/earth_properties.png
...
.. caution::
    ...
    buildings. Here, if you go deeper, the temperature **decreases** instead of **increases**. This cannot be captured within
